...
class Queries extends CI_Model {
	...
	public function viewAllColleges(){
		$this->db->select(['tbl_users.user_id', 'tbl_users.email', 'tbl_college.college_id', 'tbl_users.username',
		 'tbl_users.gender', 'tbl_college.collegename', 'tbl_college.branch', 'tbl_roles.rolename']);
	...
	public function getStudents($college_id){
		$this->db->select(['tbl_student.id', 'tbl_college.collegename', 'tbl_student.studentname',
						'tbl_student.email', 'tbl_student.gender', 'tbl_student.course']);
	...
	public function getStudentRecord($id){
		$this->db->select(['tbl_college.college_id', 'tbl_college.collegename', 'tbl_student.studentname',
						'tbl_student.id', 'tbl_student.email', 'tbl_student.gender', 'tbl_student.course']);
		$this->db->from('tbl_student');
		$this->db->join('tbl_college', 'tbl_college.college_id = tbl_student.college_id');
