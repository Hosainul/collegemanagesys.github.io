	...
	public function createcollege(){
		...
		if ( $this->form_validation->run() ) {
			...
			if ( $this->queries->makeCollege($data) ) {
				...
				$this->session->set_flashdata('message','College Creation Failed.');
				return redirect("admin/addCollege");
			}
	...
	public function createCoadmin(){
		...
		if ( $this->form_validation->run() ) {
			...
			if ($this->queries->registerCoadmin($data)) {
				...
				$this->session->set_flashdata('message','Co Admin Registered Failed.');
	...
	public function createStudent(){
		...
		if ( $this->form_validation->run() ) {
			...
			if ($this->queries->insertStudent($data)) {
				...
				$this->session->set_flashdata('message','Student Added Failed.');
